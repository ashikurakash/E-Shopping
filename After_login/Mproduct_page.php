...
<body>
  ...
  <!-- Navbar end -->
    ...
    <div class="row mt-2 pb-3">
      <?php
  			include 'config.php';
  			$stmt = $conn->prepare('SELECT * FROM macbook');
  			$stmt->execute();
  			$result = $stmt->get_result();
  			while ($row = $result->fetch_assoc()):
  		?>
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "image/popular/MacBook-M2.jpg
">
        ...
        <div class = "product-content">
          <h2 class = "product-title">Macbook M2</h2>
          ...
          <div class = "product-detail">
            ...
            <b><ol>13.6-inch (diagonal) LED-backlit display</ol></b>
            <b><ol>Up to 18 hours Apple TV app movie playback</ol></b>
            <b><ol>support for 1 billion colors</ol></b>
            <b><ol>Apple M2 chip</ol></b> 
            <b><ol>8-core GPU</ol></b>
            <b><ol>500 nits brightness</ol></b>   

            <b><ol>MagSafe 3 charging port</ol></b>           
            <b><ol>Memory 8GB</ol></b>

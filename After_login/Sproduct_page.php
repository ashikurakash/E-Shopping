...
<body>
  ...
  <!-- Navbar end -->
    ...
    <div class="row mt-2 pb-3">
      <?php
  			include 'config.php';
  			$stmt = $conn->prepare('SELECT * FROM samsung');
  			$stmt->execute();
  			$result = $stmt->get_result();
  			while ($row = $result->fetch_assoc()):
  		?>
      ...
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "image/smartphones/S23ultra.jpg">
        ...
        <div class = "product-content">
          ...
          <div class = "product-price">
            <p class = "new-price">Product Price: <span>৳130,000.00/-</span></p>
          </div>
          ...
          <div class = "product-detail">
            ...
            <b><ol>High refresh rate (120Hz)</ol></b> 
            <b><ol>Ultra powerful performance</ol></b>
            <b><ol>High screen-to-body ratio (88.57 %)</ol></b>
            <b><ol>Supports Wireless Charging</ol></b>
            <b><ol>Very strong build, excellent display</ol></b>   
            <b><ol>5Stylus Pen, Samsung DeX & more feature</ol></b>
            <b><ol>Next- level flagship cameras</ol></b>           
            <b><ol>Android 13, optimized software & security</ol></b>

...
<body>
     ...
     <div class="login-panel">
          ...
          <h1 class="label">User Signup</h1>
          <div class="login_form">

               <form action="Rsignup.php" method="post">
                    <div class="font">Enter First Name</div>
                    <input type="text" Name="RFname" placeholder="Enter First Name ">
                    <div class="font">Enter Last Name</div>
                    <input type="text" Name="RLname" placeholder="Enter Last Name ">
                    ...
                    <div class="font">Enter Mobile Name</div>
                    <input type="number" Name="Rphone" placeholder="Enter Mobile No ">
                    <button type="submit">Login</button>
                    <center>
                         <h3 class="link">Already have an account ?<br>
                              <p><a href="Login.php"> Login </a> Please</p>
